...
int ckb_load_ancestor_block_info(void* addr, uint64_t* len, size_t offset, size_t ancestor_number)
{
  return syscall(SYS_ckb_load_ancestor_block_info, addr, len, offset, ancestor_number, 0, 0);
}
